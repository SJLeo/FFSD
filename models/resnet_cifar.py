...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10, zero_init_residual=False, groups=1, 
        width_per_group=64, replace_stride_with_dilation=None, norm_layer=None, leader=False, trans_fusion_info=None):
        ...
        if self.leader:
            if trans_fusion_info is not None:
                ...
                self.trans_fusion_module = TransFusionModule(64, 8)
    ...
    def register_hook(self):
        ...
        self.extract_layers = ['layer1', 'layer2', 'layer3']
